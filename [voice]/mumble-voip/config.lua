...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Thì Thầm"}, -- Whisper speech distance in gta distance units
		{8.0, "Bình Thường"}, -- Normal speech distance in gta distance units
		{20.0, "Hét"}, -- Shout speech distance in gta distance units
	},
