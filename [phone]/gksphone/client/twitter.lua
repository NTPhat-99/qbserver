...
RegisterNUICallback('twitter_getUserTweets', function(data, cb)
  QBCore.CoreName.Functions.TriggerCallback('gksphone:getTwitterUsers', function(usersTweets)
...
RegisterNUICallback('twitter_getSearchUsers', function(data, cb)
  QBCore.CoreName.Functions.TriggerCallback('gksphone:getsearchusers', function(SearchUserTwitter)
...
RegisterNUICallback('twitter_getusertwitterr', function(data, cb)
  QBCore.CoreName.Functions.TriggerCallback('gksphone:getuserveri', function(twitteruser)
