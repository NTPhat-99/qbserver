...
RegisterNUICallback('GetBlockNumber', function(data, cb)
  QBCore.Functions.TriggerCallback('gksphone:blocknumber', function(bnumber)
...
RegisterNUICallback('getAppGallery', function(data, cb)
  QBCore.Functions.TriggerCallback('gksphone:getphonegallery', function(gallery)
...
AddEventHandler('updategallery', function(gallery)
    QBCore.Functions.TriggerCallback('gksphone:getphonegallery', function(data)
      GalleryImage(data)
    end, gallery)
end)
...
AddEventHandler('updategps', function(gps)
    QBCore.Functions.TriggerCallback('gksphone:getgps', function(data)
      GetGPS(data)
    end)
end)
...
RegisterNUICallback('getccCrypto', function(data)
  QBCore.Functions.TriggerCallback('gksphone:getsCrypto', function(data)
    setkCrypto(data)
  end)
end)
...
RegisterNUICallback('alCrypto', function(data)
  sayac = sayac + 1
  QBCore.Functions.TriggerCallback('gksphone:checkSpam', function(callback)
    sayac = callback
    if sayac == 0 then
...
AddEventHandler('yenNumber', function()
  QBCore.Functions.TriggerCallback('gksphone:blocknumber', function(data)
    setBlockNumber(data)
  end)
end)
...
RegisterNUICallback('getNewsForHaber', function(data, cb)
  QBCore.Functions.TriggerCallback('haberci:getNewsForHaber', function(news)
...
AddEventHandler("gksphone:notifi", function(data)
  QBCore.Functions.TriggerCallback('gksphone:phone-check', function(durum)
    if durum ~= nil then
...
RegisterNUICallback('aracisatt', function(data, cb) 
  timing = timing + 1
  QBCore.Functions.TriggerCallback('gksphone:vehiclecheckSpam', function(callback)
    timing = callback
    if timing == 0 then
...
RegisterNUICallback('carsellers', function(data, cb) 
  QBCore.Functions.TriggerCallback('gksphone:carsellers', function(data)
...
RegisterNetEvent("gksphone:updatecarsellers")
AddEventHandler("gksphone:updatecarsellers", function(vehiclee)
  QBCore.Functions.TriggerCallback('gksphone:carsellers', function(data)
...
RegisterNUICallback('LapDelete', function(data, cb)
  QBCore.Functions.TriggerCallback('qb-lapraces:server:LapDelete', function(races)
...
RegisterNUICallback('SetupRace', function(data, cb)
  TriggerServerEvent('qb-lapraces:server:SetupRace', data.RaceId, tonumber(data.AmountOfLaps), data.PhoneNumber, data.Katilim, data.First, data.Second, data.Third)
end)
...
AddEventHandler('gksphone:UpdateLapraces', function()
  QBCore.Functions.TriggerCallback('qb-lapraces:server:GetRaces', function(RacesOnline)
...
RegisterNUICallback('urunler', function(getirsatis)
  QBCore.Functions.TriggerCallback('qb_gotur:depoitemgotur', function(goturr)
...
RegisterNUICallback('getirsatis', function(data)
  ...
  TriggerServerEvent('qb_gotur:siparis', valcik, data.getirsatis[1].isim, data.getirsatis[1].phoneNumber, data.tutar, data.getirsatis[1].durum)
end)
...
RegisterNUICallback('urunyenile', function(data)
  ...
  TriggerServerEvent('qb_gotur:syold', data.degisik, data.tel)
end)

RegisterNUICallback('teslimonay', function(data)

  TriggerServerEvent('qb_gotur:teslimyapildi', data.degisik, data.tel)
end)
...
RegisterNUICallback('taxibilgi', function() 
  ...
  if DoesBlipExist(WaypointHandle) then
    ...
    table.insert(deneme, {price = price, street2 = street2, GPStogo = GPStogo, distance = distance, src = GetPlayerServerId(PlayerId())})
...
RegisterNUICallback('taximusteri', function(data) 
  TriggerServerEvent('gksphone:taximusteri', data.phone, data.GPStogo)
end)
