...
class GameRender {
    constructor() {
		...
		console.log(cameraRTT.position.x);
        cameraRTT.position.z = 0;
        const width = Math.floor(window.innerHeight * 12 / 8.5);
		console.log(width);
        cameraRTT.setViewOffset(window.innerWidth, window.innerHeight, window.innerWidth / 6, 0, width, window.innerHeight);
